// ignore_for_file: unused_import, depend_on_referenced_packages, library_private_types_in_public_api, unused_field, file_names, avoid_print
...
class CarSlotsBookingPage6 extends StatefulWidget {
  const CarSlotsBookingPage6({super.key});

  //final va;

  @override
  _CarSlotsBookingPage6State createState() => _CarSlotsBookingPage6State();
}

class _CarSlotsBookingPage6State extends State<CarSlotsBookingPage6> {
