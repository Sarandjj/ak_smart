// ignore_for_file: file_names, unused_import, depend_on_referenced_packages, library_private_types_in_public_api, avoid_print
...
class CarSlotsBookingPage2 extends StatefulWidget {
  const CarSlotsBookingPage2({super.key});

  //final va;

  @override
  _CarSlotsBookingPage2State createState() => _CarSlotsBookingPage2State();
}

class _CarSlotsBookingPage2State extends State<CarSlotsBookingPage2> {
                ...
                Row(
                  children: const [
                    Padding(
                      ...
                      child: Text(
                        'Parking Slot No :  2',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Color.fromARGB(229, 241, 62, 62)),
                      ),
                    ),
                    //Text(widget.va),
                  ],
