...
class CarSlotsBookingPage3 extends StatefulWidget {
  const CarSlotsBookingPage3({super.key});

  //final va;

  @override
  _CarSlotsBookingPage3State createState() => _CarSlotsBookingPage3State();
}

class _CarSlotsBookingPage3State extends State<CarSlotsBookingPage3> {
