...
// ignore_for_file: file_names, unused_import, depend_on_referenced_packages, library_private_types_in_public_api
...
class CarSlotsBookingPage1 extends StatefulWidget {
  const CarSlotsBookingPage1({super.key});

  //final va;

  @override
  _CarSlotsBookingPage1State createState() => _CarSlotsBookingPage1State();
}

class _CarSlotsBookingPage1State extends State<CarSlotsBookingPage1> {
                ...
                Row(
                  children: const [
                    Padding(
                      ...
                      child: Text(
                        'Parking Slot No :  1',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Color.fromARGB(229, 241, 62, 62)),
                      ),
                    ),
                    //Text(widget.va),
                  ],
